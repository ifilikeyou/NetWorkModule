...
#import "NetworkSpeedOC.h"
#import "NetworkModule-Swift.h"
#include <arpa/inet.h>
#include <ifaddrs.h>
#include <net/if.h>
#include <net/if_dl.h>
...
@implementation NetworkSpeedOC

+ (NetworkSpeedOC *)share{
    static NetworkSpeedOC *_instance = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        _instance = [[NetworkSpeedOC alloc] init];
    });
    return _instance;
}
...
//        NSLog(@"downloadNetworkSpeed : %@",_downloadNetworkSpeed);
        [NetworkSpeed.networkSpeed setDownloadNetworkSpeedWithSpeed:_downloadNetworkSpeed];
...
//        NSLog(@"uploadNetworkSpeed :%@",_uploadNetworkSpeed);
        [NetworkSpeed.networkSpeed setUploadNetworkSpeedWithSpeed:_uploadNetworkSpeed];
    }
